.PHONY: help install workspace fmt lint web-install web-fmt web-lint check migrate-up migrate-down migrate-version migrate-create
...
help:
	...
	@echo ""
	@echo "  install        Install golangci-lint v2, goimports, and golines (run once)"
